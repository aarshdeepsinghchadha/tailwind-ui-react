    ...
    <div className="relative">
      ...
      <div className="p-6 relative space-y-6 -mt-20">
        ...
        <div className="flex gap-6 items-start p-6">
          {/* User Card */}
          <div className="bg-white shadow-lg rounded-lg p-8 w-64 z-10 h-96 relative">
            ...
            <p className="text-lg text-gray-500 text-center">Gujarat, India</p>
          </div>

          {/* Good Morning Section */}
          <div className="flex-1 mt-24 ms-8">
        ...
        <div className="flex absolute top-2/4 justify-between left-88 w-9/12 h-auto">
          {/* Calendar */}
          <div className="bg-white shadow-lg rounded-lg p-6 flex-1 mr-5">
            <div class="flex items-center justify-between mb-6  bg-gray-100">
              <div class="flex items-center space-x-2 text-gray-700">
                <div class="flex text-xl font-semibold space-x-4 items-center">
                  <button class="text-xl p-2">
                    <Calender />
                  </button>
                  <span class="text-lg">Monday, 14 October 2024</span>
                </div>
              </div>
          ...
          {/* Actions */}
          <div className="bg-white shadow-lg rounded-lg p-6 w-1/3 h-80">
